...
class Library:
    ...
    def motive_pairs(self):
        ...
        for dna in DNAs:
            ...
            if left_motif not in leftmotifs and complementmap(left_motif) not in leftmotifs:
                leftmotifs.append(left_motif)
            if right_motif not in rightmotifs and complementmap(right_motif) not in rightmotifs:
